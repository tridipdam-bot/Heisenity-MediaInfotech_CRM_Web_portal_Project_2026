...
import { CreateLeaveApplicationRequest, ReviewLeaveApplicationRequest, LeaveType, LeaveStatus } from './leave.types'
...
export class LeaveController {
  ...
  createLeaveApplication = async (req: Request, res: Response) => {
    try {
      ...
      const requestData: CreateLeaveApplicationRequest = {
        employeeId,
        leaveType,
        startDate,
        endDate,
  ...
  getEmployeeLeaveApplications = async (req: Request, res: Response) => {
    try {
  ...
  getAllLeaveApplications = async (req: Request, res: Response) => {
    try {
  ...
  reviewLeaveApplication = async (req: Request, res: Response) => {
    try {
      ...
      const requestData: ReviewLeaveApplicationRequest = {
        applicationId,
        status,
  ...
  cancelLeaveApplication = async (req: Request, res: Response) => {
    try {
      const { applicationId } = req.params
